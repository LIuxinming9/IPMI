	...
	<script type="text/javascript">
		function queryData() 
		{
			...
			if(query){
				$.ajax({
			        type:"POST",
			        url:"${pageContext.request.contextPath}/fru/fruboardquery", 
		...
		function exportData() 
		{
			...
			var query = true;
			if(query){
				window.open("${pageContext.request.contextPath}/fru/exprotFRUboardList?&IPType=" + IPType+ "&nameType=" + nameType);	
			}
		}
	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	<nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  信息统计 <span class="c-gray en">&gt;</span> FRU信息 <span class="c-gray en">&gt;</span> 板信息 
					</nav>
	            	<div class="page-container">
	            		<div class="text-c"> 
								...
								<select id="nameType" name="nameType" class="select" style="width:120px;">
									...
									<option value="mfg_date">生产日期</option>
