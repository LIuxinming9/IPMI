	...
	<script type="text/javascript">
		function queryData() 
		{
			...
			if(query){
				$.ajax({
			        type:"POST",
			        url:"${pageContext.request.contextPath}/snmp/query", 
		...
		$("#nameType").empty();
			...
			$.post("${pageContext.request.contextPath}/snmp/changename",{IPType:IPType},function(data){
			var nameType = "";
		...
		function exportData()
		{
			...
			var query = true;
			if(query){
				window.open("${pageContext.request.contextPath}/snmp/exprotList?&nameType=" + nameType + "&IPType=" + IPType);	
			}
		}
	</script>
	<section id='content'>
	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	 <nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  信息统计 <span class="c-gray en">&gt;</span> 传感器记录  <span class="c-gray en">&gt;</span> 硬盘
					</nav> 
