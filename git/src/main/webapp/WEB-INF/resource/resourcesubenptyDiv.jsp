...
%>
<div id="resultsubDiv" class="mt-20" style="margin-top:-20px;">
		   ...
		   <table class="table table-border table-bordered table-hover table-bg table-sort3" style="table-layout:fixed;">
				<thead>
					<tr class="text-c">
	                   ...
	                   <th width="100px">可补充的部件名</th>
	                </tr>
	            </thead>
	            <tbody>
				<c:forEach items="${emptyname}" var="item" varStatus="status">
	         		<tr class="text-c">
