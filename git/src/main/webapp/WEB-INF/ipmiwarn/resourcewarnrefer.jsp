	...
	<script type="text/javascript">
		function queryData() 
		{
			...
			if(query){
				$.ajax({
			        type:"POST",
			        url:"${pageContext.request.contextPath}/resourcewarnrefer/query", 
		...
		$("#nameType").empty();
			...
			$.post("${pageContext.request.contextPath}/resourcewarnrefer/changename",{IPType:IPType},function(data){
			var nameType = "";
		...
		function exportData() 
		{
			...
			var query = true;
			if(query){
				window.open("${pageContext.request.contextPath}/resourcewarnrefer/exprotList?&nameType=" + nameType + "&IPType=" + IPType);	
			}
		}
	</script>
	<section id='content'>
	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	 <nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  告警管理 <span class="c-gray en">&gt;</span> 监控列表<span class="c-gray en">&gt;</span> 资源监控列表  
					</nav> 
