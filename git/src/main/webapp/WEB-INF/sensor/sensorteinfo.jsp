	...
	<script type="text/javascript">
		function queryData() 
		{
			...
			if(query){
				$.ajax({
			        type:"POST",
			        url:"${pageContext.request.contextPath}/sensor/sensortequery", 
		...
		$("#nameType").empty();
			...
			$.post("${pageContext.request.contextPath}/sensor/changetename",{IPType:IPType},function(data){
			var nameType = "";
		...
		function currentData()
		{
			...
			if(query){
				$.ajax({
			        type:"POST",
			        url:"${pageContext.request.contextPath}/sensor/sensortecurrentquery", 
		...
		function exportData() 
		{
			...
			if(query){
				window.open("${pageContext.request.contextPath}/sensor/exprotteList?&datemin=" + datemin + "&datemax=" + datemax+ "&IPType=" + IPType+ "&nameType=" + nameType);
			}
		}
		...
		function exportcurrentData() 
		{
			...
			var query = true;
			if(query){
				window.open("${pageContext.request.contextPath}/sensor/exprottecurrentList?&IPType=" + IPType+ "&nameType=" + nameType);
			}
		}
	</script>
	<section id='content'>
	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	<nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  信息统计 <span class="c-gray en">&gt;</span> 传感器记录<span class="c-gray en">&gt;</span> 温度 
					</nav>
