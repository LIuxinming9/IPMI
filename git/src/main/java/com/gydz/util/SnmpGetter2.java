...
public class SnmpGetter2 {

    private Snmp snmp = null;
    private int version ;

    public SnmpGetter2(int version) {
        try {
    ...
    public static void main(String[] args) {
        ...
        SnmpGetter2 manager = new SnmpGetter2(ver2c);
        // 构造报文
        PDU pdu = new PDU();
         //PDU pdu = new ScopedPDU();
        // 设置要获取的对象ID，这个OID代表远程计算机的名称
        OID oids = new OID("1.3.6.1.2.1.25.2.2.0");
        ...
        try {
            ...
            manager.sendMessage(false, true, pdu, "udp:192.168.1.179/161");//192.168.1.233 WinServer2008服务器
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
