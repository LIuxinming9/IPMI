...
public class CipherSuite {
	...
	public CipherSuite(byte id, byte authenticationAlgorithm,
			byte confidentialityAlgorithm, byte integrityAlgorithm,
			AuthenticationAlgorithm aa,ConfidentialityAlgorithm ca,IntegrityAlgorithm ia) {
		this.id = id;
		this.authenticationAlgorithm = (authenticationAlgorithm);
		this.confidentialityAlgorithm = (confidentialityAlgorithm);
		this.integrityAlgorithm = (integrityAlgorithm);
	 ...
	 * ��Ϊ������16�ֽڵ����ݰ���ʽ���֣������Ƿֶεġ�ÿ���׼�ֻ֧��һ�������Ժ�һ���������㷨��
	 * 
	 * @param bytes
	...
	public String toString() {
		return "CipherSuite [id=" + id + ", authenticationAlgorithm=" + authenticationAlgorithm
				+ ", integrityAlgorithm=" + integrityAlgorithm + ", confidentialityAlgorithm="
				+ confidentialityAlgorithm + ", aa=" + aa + ", ca=" + ca + ", ia=" + ia + "]";
	}
