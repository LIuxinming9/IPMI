 ...
 * RMCP+ RAKP3消息及其响应- RAKP4消息的包装器。
 */
public class Rakp3 extends IpmiCommandCoder {

	@Override
	public String toString() {
		return "Rakp3 [statusCode=" + statusCode + ", managedSystemSessionId=" + managedSystemSessionId + ", rakp1="
				+ rakp1 + ", rakp1ResponseData=" + rakp1ResponseData + "]";
	}
	 ...
	 *            - The Managed System锟絪 Session ID for this session. Must be as
	 ...
	 *         字节数组保存为计算RAKP消息3的KeyExchangeAuthenticationCode而准备的基
	 */
