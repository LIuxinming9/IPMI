...
public class SelRecord {
	...
	public String toString() {
		return "SelRecord [recordId=" + recordId + ", recordType=" + recordType + ", timestamp=" + timestamp
				+ ", sensorType=" + sensorType + ", sensorNumber=" + sensorNumber + ", eventDirection=" + eventDirection
				+ ", event=" + event + ", reading=" + reading + "]";
	}
