 ...
 * 此记录用于表示包含或由其他实体包含的实体之间的关系。
 */
public class EntityAssociationRecord extends SensorRecord {

	@Override
	public String toString() {
		return "EntityAssociationRecord [containerEntityId=" + containerEntityId + ", containerEntityInstance="
				+ containerEntityInstance + ", entitiesAsRange=" + entitiesAsRange + ", recordLink=" + recordLink
				+ ", entityRange1=" + entityRange1 + ", entityRangeInstance1=" + entityRangeInstance1
				+ ", entityRange2=" + entityRange2 + ", entityRangeInstance2=" + entityRangeInstance2
				+ ", entityRange3=" + entityRange3 + ", entityRangeInstance3=" + entityRangeInstance3
				+ ", entityRange4=" + entityRange4 + ", entityRangeInstance4=" + entityRangeInstance4 + "]";
	}
