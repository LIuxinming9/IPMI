 ...
 * 这个记录与{@link EntityAssociationRecord}相同，
 * 只是它支持描述具有设备相关的实体实例值和系统相关值的实体之间的关联。
 */
public class DeviceRelativeEntityAssiciationRecord extends SensorRecord {

	@Override
	public String toString() {
		return "DeviceRelativeEntityAssiciationRecord [containerEntityId=" + containerEntityId
				+ ", containerEntityInstance=" + containerEntityInstance + ", containerEntityDeviceAddress="
				+ containerEntityDeviceAddress + ", containerEntityDeviceChannel=" + containerEntityDeviceChannel
				+ ", entitiesAsRange=" + entitiesAsRange + ", recordLink=" + recordLink + ", entityDeviceAddress1="
				+ entityDeviceAddress1 + ", entityDeviceChannel1=" + entityDeviceChannel1 + ", entityRange1="
				+ entityRange1 + ", entityRangeInstance1=" + entityRangeInstance1 + ", entityDeviceAddress2="
				+ entityDeviceAddress2 + ", entityDeviceChannel2=" + entityDeviceChannel2 + ", entityRange2="
				+ entityRange2 + ", entityRangeInstance2=" + entityRangeInstance2 + ", entityDeviceAddress3="
				+ entityDeviceAddress3 + ", entityDeviceChannel3=" + entityDeviceChannel3 + ", entityRange3="
				+ entityRange3 + ", entityRangeInstance3=" + entityRangeInstance3 + ", entityDeviceAddress4="
				+ entityDeviceAddress4 + ", entityDeviceChannel4=" + entityDeviceChannel4 + ", entityRange4="
				+ entityRange4 + ", entityRangeInstance4=" + entityRangeInstance4 + "]";
	}
	...
	private int containerEntityDeviceChannel;//通道
