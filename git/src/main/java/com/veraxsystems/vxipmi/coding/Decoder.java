 ...
 * 将RMCP包解码为{@link ResponseData}。
 */
public final class Decoder {

	/**
	 * Decodes raw data into将原始数据解码成 {@link ResponseData} - a wrapper包装 class for
	 * message-specific response data.于消息响应数据。
	 * 
	 * @param data
	 *            - raw RMCP packet to be decoded
	 * @param protocolDecoder协议解码
	 ...
	 * @param commandCoder命令编码器
	 *            - instance of {@link IpmiCommandCoder} class used for wrapping
	 *            payload有效载荷 into message-dependent {@link ResponseData} object.
