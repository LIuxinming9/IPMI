...
/**
 * Power Supply Information电力供应信息 record from FRU Multi Record Area
 */
public class PowerSupplyInfo extends MultiRecordInfo {

	/**
	 * Overall Capacity in Watts总功率(瓦特)
	 */
	 ...
	 * 这指定输入电源的可接受电压的下限。如果电源不支持自动切换，则使用此字段。
	 * 量程1将定义110V量程，量程2将用于220V量程。单位是10mV。
	 */
