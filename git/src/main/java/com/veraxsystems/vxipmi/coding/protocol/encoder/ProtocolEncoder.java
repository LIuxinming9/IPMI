 ...
 * 将IPMI会话头添加到加密的有效负载。应该用于编码常规RMCP+消息(不包括开放会话和RAKP消息)
 */
public abstract class ProtocolEncoder implements IpmiEncoder {
	 ...
	 * 使用小endian约定将整数值转换为字节数组，并将其插入到给定偏移量的消息中。
	 * @param value
	 * @param message
