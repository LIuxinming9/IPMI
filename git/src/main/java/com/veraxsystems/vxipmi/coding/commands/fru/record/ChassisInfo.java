...
/**
 * FRU record containing Chassis底盘 info.<br>
 * This area is used to hold Serial Number, Part Number, and other information
 * about the system chassis.
 * 此区域用于保存关于系统机箱的序列号、部件号和其他信息。
 */
public class ChassisInfo extends FruRecord {

	@Override
	public String toString() {
		return "ChassisInfo [chassisType=" + chassisType + ", chassisPartNumber=" + chassisPartNumber
				+ ", chassisSerialNumber=" + chassisSerialNumber + ", customChassisInfo="
				+ Arrays.toString(customChassisInfo) + "]";
	}

	private ChassisType chassisType;//系统机箱的底盘类型

	private String chassisPartNumber = "";//底盘部件编号

	private String chassisSerialNumber = "";//底盘序列号
