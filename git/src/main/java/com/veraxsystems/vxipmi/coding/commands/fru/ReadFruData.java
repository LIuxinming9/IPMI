 ...
 * 该命令从FRU库存信息区域返回指定的数据。
 */
public class ReadFruData extends IpmiCommandCoder {

	@Override
	public String toString() {
		return "ReadFruData [offset=" + offset + ", size=" + size + ", fruId=" + fruId + "]";
	}
	 ...
	 * 为编码和解码启动ReadFruData。将会话参数设置为默认值。
	 * 
	...
	public ReadFruData(int fruId, BaseUnit unit, int offset, int countToRead) {
		...
		//检查Count To Read字段是否以单词编码，如果FRU以单词寻址(需要不同的服务器设置)。
	}
