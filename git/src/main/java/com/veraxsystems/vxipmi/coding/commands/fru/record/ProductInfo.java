 ...
 * 如果FRU本身是一个单独的产品，则会出现此区域。当FRU是外接卡时，通常可以看到这一点。
 * 在包含底盘信息区域的FRU信息设备中提供此区域时，产品信息用于整个系统，如最初制造的那样。
 */
public class ProductInfo extends FruRecord {

	@Override
	public String toString() {
		return "ProductInfo [manufacturerName=" + manufacturerName + ", productName=" + productName
				+ ", productModelNumber=" + productModelNumber + ", productVersion=" + productVersion
				+ ", productSerialNumber=" + productSerialNumber + ", assetTag=" + assetTag + ", fruFileId="
				+ Arrays.toString(fruFileId) + ", customProductInfo=" + Arrays.toString(customProductInfo) + "]";
	}

	private String manufacturerName = "";//制造商的名字
	...
	private String[] customProductInfo = new String[0];//定制产品信息
