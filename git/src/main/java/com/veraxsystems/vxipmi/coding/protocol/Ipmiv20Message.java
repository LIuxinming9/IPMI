...
public class Ipmiv20Message extends IpmiMessage {
	...
	private boolean payloadEncrypted;//��Ч�غɼ���

	@Override
	public String toString() {
		return "Ipmiv20Message [payloadEncrypted=" + payloadEncrypted + ", payloadAuthenticated=" + payloadAuthenticated
				+ ", payloadType=" + payloadType + ", oemIANA=" + oemIANA + ", oemPayloadID=" + oemPayloadID + "]";
	}

	private boolean payloadAuthenticated;//��Ч�غ���֤
