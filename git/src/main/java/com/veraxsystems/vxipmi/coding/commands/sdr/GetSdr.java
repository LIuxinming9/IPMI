...
public class GetSdr extends IpmiCommandCoder {
	...
	public String toString() {
		return "GetSdr [reservationId=" + reservationId + ", recordId=" + recordId + ", offset=" + offset
