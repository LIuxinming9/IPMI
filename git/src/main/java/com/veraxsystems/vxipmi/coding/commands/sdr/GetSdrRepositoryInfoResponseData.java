...
public class GetSdrRepositoryInfoResponseData implements ResponseData {
	...
	public String toString() {
		return "GetSdrRepositoryInfoResponseData [sdrVersion=" + sdrVersion + ", recordCount=" + recordCount
				+ ", addTimestamp=" + addTimestamp + ", delTimestamp=" + delTimestamp + ", reserveSupported="
				+ reserveSupported + "]";
	}
	 ...
	 */
	private int recordCount;//¼ÇÂ¼¼ÆÊý
