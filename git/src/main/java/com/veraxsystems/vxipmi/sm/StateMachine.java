...
public class StateMachine implements UdpListener {
	...
	public String toString() {
		return "StateMachine [observers=" + observers + ", current=" + current + ", messenger=" + messenger
				+ ", remoteMachineAddress=" + remoteMachineAddress + ", initialized=" + initialized + "]";
	}

	private List<MachineObserver> observers;// �۲���

	private State current;//��ǰ��
