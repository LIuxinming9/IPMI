...
public class IpmiConnector {
    ...
    private int idleTime;//����ʱ��

    private Random random = new Random(System.currentTimeMillis());

    /**
     * Starts {@link IpmiConnector} and initiates the {@link ConnectionManager} at the given port. Wildcardͨ��� IP address
     * will be used.
     * @param port
    ...
    /**
     * Gets the authentication�����֤ capabilities for the connection with the remote host.
     * @param connectionHandle
