 ...
 * {@link ConnectionHandle}ͨ��{@link #createConnection(InetAddress)}
 * 
 * <li>Get {@link CipherSuite}s that are available for the connection via
 * Get {@link CipherSuite}s����ͨ�������ӻ�ȡ
 * Cipher����
 * 
